...
$to = '';
$subject = 'AM Training Institute - Reset Password';
$headers = 'From: '. $from . "\r\n";
...
if ($_SERVER['REQUEST_METHOD']==='POST')
{
	...
	$sql = "Call Get_User_DataFromEmail('". $user_email . "');";	      
  ...
  <div class="container col-xl-10 col-xxl-8 px-4 py-5">
    <div class="row align-items-center g-lg-5 py-5">
      <div class="col-lg-7 text-center text-lg-start">
        ...
        <p class="col-lg-10 fs-4">Forgot your password! No problem, we'll send you an email to reset it.</p>		
      </div>
      <div class="col-md-10 mx-auto col-lg-5">
		...
		<h5>Email Address</h5>		
          ...
          <div class="form-floating mb-3">
            <input type="text" class="form-control" id="user_email" name="user_email" placeholder="<?=$user_email?>" value="<?=$user_email?>">
