...
{		
	...
	$message .= '          <li class="mb-1">610 North Alma School Rd., STE 4, Chandler, AZ 85224</li>';
	$message .= '        </ul>';
	$message .= '      </div>';
	$message .= '      <div class="col-6 col-md">';
	$message .= '        <h5>Contact</h5>';
	$message .= '        <ul class="list-unstyled text-small">';
	$message .= '          <li class="mb-1">Name: AM Training Institute</li>';
	$message .= '          <li class="mb-1">Phone: 480.975.8810</li>';
	$message .= '          <li class="mb-1">Email: <a href="mailto:info@amtraininginstitute.com">info@amtraininginstitute.com</a></li>';
	$message .= '          <li class="mb-1">Address: 610 North Alma School Rd., STE 4, Chandler, AZ 85224</li>';
	$message .= '          <li class="mb-1">Website: <a href="https://amtraininginstitute.com">amtraininginstitute.com</a></li>';
	$message .= '        </ul>';
	$message .= '      </div>';
	$message .= '      <div class="col-6 col-md">';
	$message .= '        <h5>Email</h5>';
	$message .= '        <ul class="list-unstyled text-small">';
	$message .= '          <li class="mb-1"><a href="mailto:info@amtraininginstitute.com">info@amtraininginstitute.com</span></a></li>';          
	$message .= '        </ul>';
	$message .= '      </div>';
	$message .= '    </div>';
	$message .= '  </footer>';
