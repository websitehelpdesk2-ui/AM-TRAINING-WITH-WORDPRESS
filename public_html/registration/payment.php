...
<main>
<h2><?=$options[3]?></h2>	
<object data="<?=$options[4]?>.pdf" type="application/pdf" style="height: 600px; max-width: 56rem; width: 80%;" aria-label="PDF format">
  <iframe src="https://docs.google.com/viewer?url=https%3A%2F%2Famtraininginstitute.org%2Fregistration%2F<?=$options[4]?>.pdf&embedded=true" style="height: 600px; max-width: 56rem; width: 80%;" frameborder="1" scrolling="auto"></iframe>
</object>
...
<a href="notification.php?<?=$url?>" class="btn btn-primary">Submit</a>
</main>
